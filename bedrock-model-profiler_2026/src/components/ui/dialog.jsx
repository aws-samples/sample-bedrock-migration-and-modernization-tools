        ...
        <DialogPrimitive.Content
          ...
          className={cn(
            ...
            isLight
              ...
              : 'border-slate-700/50 bg-gradient-to-br from-slate-800/95 via-slate-900/95 to-slate-950/95 backdrop-blur-xl shadow-2xl shadow-black/40 ring-1 ring-white/10',
            className
          )}
          {...props}
        >
          ...
          <DialogPrimitive.Close className={cn(
            ...
            isLight
              ...
              : 'ring-offset-transparent focus:ring-[#1A9E7A] data-[state=open]:bg-slate-800 data-[state=open]:text-slate-400'
          )}>
            <X className={cn('h-4 w-4', isLight ? 'text-stone-500' : 'text-slate-400')} />
